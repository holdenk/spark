...
pyspark_sql = Module(
    ...
    python_test_goals=[
        ...
        "pyspark.sql.tests.arrow.test_arrow_python_udf_transpile_parity",
        "pyspark.sql.tests.arrow.test_arrow_python_udf_transpile_type_canary",
        ...
        "pyspark.sql.tests.pandas.test_pandas_udf_transpile_parity",
